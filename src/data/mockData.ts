...
export const INITIAL_ARTWORKS: Artwork[] = [
  ...
  },
  {
    id: 'artwk-4',
    uuid: 'ART-2024-004',
    artworkNumber: 'ART-2024-004',
    titleAr: 'حوار الرمال والفضة',
    titleFr: 'Dialogue des Sables et de l’Argent',
    artistId: 'art-1',
    artistNameAr: 'محمد الجالي',
    artistNameFr: 'Mohamed El Gali',
    year: 2023,
    mediumAr: 'وسائط متعددة ورقائق الفضة',
    mediumFr: 'Technique mixte et feuilles d’argent',
    materialAr: 'قماش كتان مع ورق فضي',
    materialFr: 'Toile en lin et argent',
    dimensions: { height: 110, width: 150, unit: 'cm' },
    weightKg: 6,
    styleAr: 'تجريدي فاخر',
    styleFr: 'Abstrait Luxueux',
    categoryAr: 'وسائط متعددة',
    categoryFr: 'Techniques mixtes',
    purchaseCostMAD: 35000,
    sellingPriceMAD: 80000,
    estimatedValueMAD: 85000,
    insuranceValueMAD: 90000,
    commissionRate: 15,
    descriptionAr: 'قصة الصحراء المغربية والفضة السوسية تحكيها الريشة الذهبية للفنان محمد الجالي.',
    descriptionFr: 'Une histoire du désert marocain et de l’argent soussi racontée par Mohamed El Gali.',
    status: 'available',
    primaryImage: 'https://images.unsplash.com/photo-1549887534-1541e9326642?w=800&auto=format&fit=crop&q=80',
    galleryImages: [
      'https://images.unsplash.com/photo-1549887534-1541e9326642?w=800&auto=format&fit=crop&q=80'
    ],
    location: 'مخزن المعرض - طنجة',
    warehouseId: 'wh-4',
    isUnique: true,
  ...
  },
  {
    id: 'artwk-5',
    uuid: 'ART-2024-005',
    artworkNumber: 'ART-2024-005',
    titleAr: 'الأفق الأطلسي المفتوح',
    titleFr: 'L’Horizon Atlantique Ouvert',
    artistId: 'art-1',
    artistNameAr: 'محمد الجالي',
    artistNameFr: 'Mohamed El Gali',
    year: 2024,
    ...
    materialAr: 'قماش كتان بلجيكي',
    materialFr: 'Toile de lin belge',
    dimensions: { height: 120, width: 180, unit: 'cm' },
    weightKg: 7,
    styleAr: 'تجريدي معاصر',
    styleFr: 'Abstrait Contemporain',
    categoryAr: 'لوحات زيتية',
    categoryFr: 'Peinture à l’huile',
    purchaseCostMAD: 40000,
    sellingPriceMAD: 95000,
    estimatedValueMAD: 100000,
    insuranceValueMAD: 110000,
    commissionRate: 15,
    descriptionAr: 'عمل متحفي حظي باهتمام النقاد في معرض الربيع الفني، بيعت لمقتني رئيسي بالدار البيضاء.',
    descriptionFr: 'Œuvre muséale vendue à un grand collectionneur à Casablanca.',
    status: 'sold',
    primaryImage: 'https://images.unsplash.com/photo-1578926375605-eaf7559b1458?w=800&auto=format&fit=crop&q=80',
    galleryImages: [
      'https://images.unsplash.com/photo-1578926375605-eaf7559b1458?w=800&auto=format&fit=crop&q=80'
    ],
    location: 'مجموعة خاصة - أحمد العتيبي',
